...
class _AddAssignmentScreenState extends State<AddAssignmentScreen> {
  ...
  Future<void> _save() async {
    ...
    final assignment = Assignment(
      id: widget.assignment?.id ?? p.nextId,
          ...
          children: [
            _section('Assignment Details', [
              ...
              _field('Subject *', _subjectCtrl, 'e.g. CSE 3102',
                  validator: (v) => v!.trim().isEmpty ? 'Subject required' : null),
              const SizedBox(height: 14),
              _field('Description', _descCtrl, 'Optional notes...', maxLines: 3),
            ]),
            ...
            _section('Settings', [
              ...
              const SizedBox(height: 14),
              _dropdown('Status', _status, ['Pending', 'In Progress', 'Completed'],
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      TextFormField(
        ...
        decoration: InputDecoration(
          hintText: hint,
          hintStyle: TextStyle(fontSize: 13, color: scheme.onSurface.withOpacity(0.3)),
